      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Take back control of your device identity and ad data. For developers: integrate privacy-first user & device
            login into your app.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <Link
            href="#"
            onClick={(e) => {
              e.preventDefault() /* TODO: Add wallet connect logic */
            }}
          >
            <Button
          ...
          <Link
            href="#"
            onClick={(e) => {
              e.preventDefault() /* TODO: Add developer docs link */
            }}
          >
            <Button
              variant="outline"
              className="px-[30px] py-2 border-white/20 text-foreground hover:bg-white/5 text-base font-medium leading-6 rounded-[99px] transition-all duration-200 bg-transparent"
              size="lg"
            >
              Build on Us
            </Button>
